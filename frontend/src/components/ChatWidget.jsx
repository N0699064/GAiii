  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 w-14 h-14 bg-purple-600 hover:bg-purple-700 rounded-full shadow-lg flex items-center justify-center transition-all hover:scale-110 z-50"
      >
      ...
      {isOpen && (
        <div className="fixed bottom-24 right-6 w-80 bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden z-50">
          <div className="bg-purple-600 text-white p-4">
            <h3 className="font-bold">FutureFlow AI</h3>
            <p className="text-purple-200 text-sm">We typically reply within minutes</p>
          </div>
