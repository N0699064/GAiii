      ...
      <div className="relative z-10 max-w-5xl mx-auto px-8 md:px-12">
        <div className="grid lg:grid-cols-2 gap-6 items-center">
          ...
          <div>
            ...
            <a
              href="#booking"
              className="inline-block bg-gray-900 hover:bg-gray-800 text-white px-4 py-2 rounded-lg font-semibold text-sm transition-all hover:shadow-lg"
            >
              Book a Demo
            </a>
          </div>
          ...
          <div className="relative h-48 md:h-56">
            {/* Salesforce */}
            <div className="absolute top-0 right-1/4 w-12 h-12 md:w-14 md:h-14 bg-white rounded-full shadow-xl flex items-center justify-center animate-float" style={{ animationDelay: '0s' }}>
            ...
            {/* Pipedrive */}
            <div className="absolute top-2 right-4 w-10 h-10 md:w-12 md:h-12 bg-white rounded-full shadow-xl flex items-center justify-center animate-float" style={{ animationDelay: '0.5s' }}>
              <span className="text-lg md:text-xl font-bold text-green-600">P</span>
            </div>
            
            {/* Monday.com */}
            <div className="absolute top-12 right-0 w-12 h-12 md:w-14 md:h-14 bg-white rounded-full shadow-xl flex items-center justify-center animate-float" style={{ animationDelay: '1s' }}>
              <div className="flex gap-0.5">
                <div className="w-1.5 h-3 bg-yellow-400 rounded-sm"></div>
                <div className="w-1.5 h-3 bg-green-500 rounded-sm"></div>
                <div className="w-1.5 h-3 bg-pink-500 rounded-sm"></div>
              </div>
            </div>
            
            {/* Pipedrive green */}
            <div className="absolute top-1/4 left-2 w-10 h-10 md:w-12 md:h-12 bg-white rounded-full shadow-xl flex items-center justify-center animate-float" style={{ animationDelay: '1.5s' }}>
              <div className="w-6 h-6 md:w-7 md:h-7 bg-green-500 rounded-lg flex items-center justify-center">
                <span className="text-white font-bold text-xs">p</span>
              </div>
            </div>
            
            {/* HubSpot */}
            <div className="absolute top-1/3 left-1/4 w-11 h-11 md:w-13 md:h-13 bg-white rounded-full shadow-xl flex items-center justify-center animate-float" style={{ animationDelay: '2s' }}>
              <svg className="w-6 h-6 md:w-7 md:h-7" viewBox="0 0 24 24" fill="#FF7A59">
            ...
            {/* Monday dots */}
            <div className="absolute bottom-1/4 left-1/3 w-12 h-12 md:w-14 md:h-14 bg-white rounded-full shadow-xl flex items-center justify-center animate-float" style={{ animationDelay: '0.8s' }}>
            ...
            {/* Asana */}
            <div className="absolute bottom-4 right-1/4 w-12 h-12 md:w-14 md:h-14 bg-white rounded-full shadow-xl flex items-center justify-center animate-float" style={{ animationDelay: '2.5s' }}>
            ...
            {/* Analytics */}
            <div className="absolute bottom-2 left-1/4 w-10 h-10 md:w-12 md:h-12 bg-white rounded-full shadow-xl flex items-center justify-center animate-float" style={{ animationDelay: '1.2s' }}>
              <div className="flex gap-0.5 items-end">
                <div className="w-1 h-2 bg-yellow-400 rounded-sm"></div>
